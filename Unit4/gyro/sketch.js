...
let maoiImage, fonts, background;
let xPosition = 0;
let yPosition = 0;
...
function setup() {
  ...
  maoiImage = loadImage("maoi.png");
  fonts = loadFont("NewRodinB.otf");
  imageMode(CENTER);
  rectMode(CENTER);
...
function draw() {
  ...
  image(background, width/2, height/2, width, height); // light blue
